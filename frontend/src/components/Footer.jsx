const Footer = () => {
	return (
		<div className='bg-dark-bg p-2 mt-4 border-t-[1px] border-dark-border'>
			<section className='grid grid-cols-1 gap-2 text-dark-text-primary font-primary p-2  sm:p-4 md:px-8 '>
				<div className=' flex flex-col-reverse gap-4  sm:grid sm:grid-cols-3'>
					<div className='flex justify-around sm:col-span-2 border-r-[1px] border-dark-border sm:flex justify-center items-center gap-4 sm:gap-2 md:gap-12 '>
